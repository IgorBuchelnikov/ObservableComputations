...
See [Two computation states: active and inactive](#two-computation-states-active-and-inactive) section for details. For other changes, see the Release Notes section at [NuGet](https://www.nuget.org/packages/ObservableComputations/2.0.0).
