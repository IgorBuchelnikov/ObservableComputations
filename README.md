...
[ReactiveUI](https://github.com/reactiveui/ReactiveUI) and [DynamicData](https://github.com/reactiveui/DynamicData) do roughly the same thing as ObservableComputations, but ObservableComputations is less verbose, simpler in use, faster, since it accesses the source data less.
