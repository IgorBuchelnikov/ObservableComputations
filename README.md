...
* [ReactiveUI](https://github.com/reactiveui/ReactiveUI) is an MVVM framework with reactive functionality. ObservableComputations only targets reactive functionality. With ObservableComputations, you can use any MVVM framework, implement MVVM pattern yourself, or not follow MVVM pattern at all
